...
<input className='w-full px-2 py-2.5 border border-grey-500/30 rounded outline-none text-grey-500 focus:border-primary transition'
 type={type}
            ...
            <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                     ...
                     <InputField handleChange={handleChange} address={address} 
                    name='phone' type="text" placeholder="Street"/>
